<template>
  <div>
   ...
   <BasicTable @register="registerTable" :rowSelection="rowSelection">
     <!--插槽:table标题-->
      <template #tableTitle>
          <a-button type="primary" v-auth="'ad:ad_publish_detail:add'" @click="handleAdd" preIcon="ant-design:plus-outlined"> 新增</a-button>
          <a-button  type="primary" v-auth="'ad:ad_publish_detail:exportXls'" preIcon="ant-design:export-outlined" @click="onExportXls"> 导出</a-button>
          <j-upload-button type="primary" v-auth="'ad:ad_publish_detail:importExcel'" preIcon="ant-design:import-outlined" @click="onImportXls">导入</j-upload-button>
          <a-dropdown v-if="selectedRowKeys.length > 0">
              ...
              <a-button v-auth="'ad:ad_publish_detail:deleteBatch'">批量操作
...
<script lang="ts" name="ad-adPublishDetail" setup>
       ...
       return [
         {
           ...
           auth: 'ad:ad_publish_detail:delete'
         }
       ]
   }
