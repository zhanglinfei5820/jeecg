 ...
 */
@Data
@TableName("ad_driver_settlement")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@Schema(description="司机结算表")
public class AdDriverSettlement implements Serializable {
	...
	/**维护次数*/
	@Excel(name = "维护次数", width = 15)
    @Schema(description = "维护次数")
    private java.lang.Integer maintenanceCount;
	/**维护金额*/
	@Excel(name = "维护金额", width = 15)
    @Schema(description = "维护金额")
    private java.math.BigDecimal maintenanceAmount;
	/**广告收益*/
	@Excel(name = "广告收益", width = 15)
    @Schema(description = "广告收益")
    private java.math.BigDecimal adAmount;
	/**总金额*/
